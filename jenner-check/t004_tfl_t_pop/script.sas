...
** (provided by autoexec.sas in this bundle: __prog_name, ADAM/TFL/METADATA
**  libnames, and the metadata.t_pop display row);
*********;
...
** surface the built table dataset (the ODS PDF is written to ./t_pop.pdf);
proc print data = tfl.t_pop label;
	title "t_pop: Summary of Populations (table dataset)";
run;
